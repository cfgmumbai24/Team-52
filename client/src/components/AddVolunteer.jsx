...
const AddVolunteer = () => {
  ...
  return (
    <div className="max-w-[900] mx-auto flex flex-col items-center h-[100vh] justify-center">
      {/* changed here added flex flex-col items center */}
      <div>
        <p className="font-bold mx-8 text-[#0F75BD]  lg:text-5xl md:ext-4xl text-2xl max-w-[1240px] items-center justify-center ">
          {" "}
          Add Volunteer
        </p>
      </div>
